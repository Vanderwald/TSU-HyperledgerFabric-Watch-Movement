...
*/
func (s *SmartContract) queryWatchMovement(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
*/
func (s *SmartContract) recordWatchMovement(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
*/
func (s *SmartContract) queryAllWatchMovement(APIstub shim.ChaincodeStubInterface) sc.Response {
...
*/
func (s *SmartContract) changeWatchMovementHolder(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
